      ...
      <section className="bg-gradient-to-r from-blue-100 via-blue-50 to-white py-20 px-4 md:px-16">
        <div className="max-w-6xl mx-auto text-center">
         ...
         Enterprise Security
          ...
          Comprehensive security solutions built for modern enterprises with zero-trust architecture.
          </p>
      ...
      {[
        {
          ...
          description: 'Never trust, always verify — ensures continuous authentication across your system.',
          icon: '🔒',
        },
        {
          title: 'Advanced Encryption',
          description: 'Protect data in transit and at rest using industry-standard encryption protocols.',
          icon: '🛡️',
        },
        {
          title: 'Compliance Automation',
          description: 'Automate auditing and reporting to meet regulatory standards effortlessly.',
          icon: '📜',
        },
        {
          title: 'Threat Detection',
          description: 'Real-time monitoring to identify and respond to potential threats instantly.',
          icon: '🚨',
        },
      ].map((feature) => (
        <div
